  ...
  try {
      ...
      try {
          ...
          try {
              ...
              let options3 = {
                  method: 'GET',
                  url: appEnv.app.cf_api + '/v3/apps?organization_guids=' + appEnv.app.organization_id + '&space_guids=' + appEnv.app.space_id + '&names=' + 'grafmodellezo-app',
                  headers: {
    ...
    try {
        ...
        try {  
            ...
            try {
                ...
                let options2 = {
                    method: 'GET',
                    url: appEnv.app.cf_api + '/v3/apps/' + connectRes.application_id + '/routes?hosts=' + subdomain + '-' + appEnv.app.space_name + '-grafmodellezo-app',
                    headers: {
                        'Authorization': 'Bearer ' + connectRes.access_token
                    }
                };
...
module.exports = (service) => {
  ...
  service.on('UPDATE', 'tenant', async (req, next) => {
    ...
    let appuri = "-dev-mtxsm-app.cfapps.eu10.hana.ondemand.com";
    ...
    let tenant = req.data.subscribedSubdomain + '-' + appEnv.app.space_name.toLowerCase().replace(/_/g,'-') + '-' + 'grafmodellezo-app';
